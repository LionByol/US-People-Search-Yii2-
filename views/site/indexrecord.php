...
$this->title = 'Court Search - Hero Searches';
?>
                ...
                <center>
                    <form class="form-inline">
                        <div class="form-group width-45 response-width-search">
                            <input type="text" class="form-control search-field" placeholder="e.g. Genesis P Orridge" id="search-name">
                        </div>
                        <div class="form-group has-feedback width-45 response-width-search">
                            <input type="text" class="form-control search-field" id="search-address" placeholder="City, State">
                            <span class="fa fa-search form-control-feedback font-26" style="width:50px;height:50px;line-height:50px !important;z-index: 10;pointer-events: auto;cursor: pointer;" ></span>
                        </div>
                    </form>
