...
$this->title = 'People Search - Hero Searches';
?>
                ...
                <center>
                    <form id="people-form" class="form-inline" method="post" action="<?= Url::to(["search/peoplename"]) ?>">
                        <div class="form-group width-45 response-width-search">
                            <input type="text" class="form-control search-field" placeholder="e.g. Jon Sonw" id="search-name" onkeyup="onPeopleNameChange()" name="name">
                        </div>
                        <div class="form-group has-feedback width-45 response-width-search">
                            <input type="text" class="form-control search-field" id="search-address" placeholder="City, State or ZIP" name="address">
