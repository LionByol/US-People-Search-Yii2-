...
$this->title = 'Sign up - Hero Searches';
$this->params['breadcrumbs'][] = $this->title;
?>
<br>
<div class="container" id="signup-div">
	<h3 class="text-center">Get the most powerful people data available with Hero Searches Member</h3>
	<br>
        ...
        <div class="col-md-4">
        	<div class="pv-20 ph-20 feature-box-2 light-gray-bg boxed shadow object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
                <div class="body" style="margin-left: 20px;">
                    ...
                    <?= $form->field($usermdl, 'name')->textInput(['class' => 'form-control']) ?>
        	...
        	<div class="pv-20 ph-20 feature-box-2 light-gray-bg boxed shadow object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
        		<div class="body" style="margin-left: 20px;">
	        		...
	        		<div class="row">
	        			...
	        			<div class="col-lg-6">
	        				<?= $form->field($usermdl, 'active_account')->checkbox(['checked' => 'checked', 'required' => true]) ?>
	        			</div>
	        			<div class="col-lg-6">
	        				<?= $form->field($usermdl, 'active_phone')->checkbox(['checked' => 'checked']) ?>
	        			</div>
	        		</div>
                    <div class="separator mt-10"></div>
                    <div class="row">
                        <div class="col-lg-10 col-lg-offset-1">
                            <?= $form->field($cardmdl, 'name')->textInput(['class' => 'form-control']) ?>
                        </div>
                        <div class="col-lg-10 col-lg-offset-1">
